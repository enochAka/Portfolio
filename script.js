window.addEventListener("load", () => {
  ...
  const mobileIcon = document.getElementById("iconMobile");
  ...
  const menuButton = document.getElementById("menu-icon-container");
  ...
  setTimeout(() => {
    availableDiv.style.animation = "float-in 1s ease-in-out forwards";
    availableDiv.style.display = "flex";
  }, 100);
  setTimeout(() => {
    introductionHeading.style.animation = "float-in 1s ease-in-out forwards";
    introductionHeading.style.display = "block";
  }, 200);
  setTimeout(() => {
    descriptionSubHeading.style.animation = "float-in 1s ease-in-out forwards";
    descriptionSubHeading.style.display = "flex";
  }, 300);
  setTimeout(() => {
    descriptionParagraph.style.animation = "float-in 1s ease-in-out forwards";
    descriptionParagraph.style.display = "flex";
  }, 400);
  setTimeout(() => {
    quickActionButtons.style.animation = "float-in 1s ease-in-out forwards";
    quickActionButtons.style.display = "flex";
  }, 500);
  setTimeout(() => {
    scrollPrompt.style.animation = "float-in 1s ease-in-out forwards";
  ...
  window.addEventListener("scroll", () => {
    ...
    if (scrollAmount > window.innerHeight * 1.2) {
      projectsDiv.style.animation = "float-in 1s ease-in-out forwards";
      projectsDiv.style.display = "block";
    }
    if (scrollAmount > window.innerHeight * 2.5) {
  ...
  menuButton.addEventListener("click", () => {
    ...
    mobileMenu.style.animation = "rollDownNav 1s ease-in-out";
    ...
    closeIcon.addEventListener("click", () => {
        ...
        mobileMenu.style.animation = "rollUpNav 1s ease-in-out";
        mobileIcon.classList.remove("fade-out");
        setTimeout(() => {
